...
Peripherals::Peripherals()
    ...
    // Sliders
    , instrumentSliders {
        TeensySlider(PIN_POT_INST_1, 64),
        TeensySlider(PIN_POT_INST_2, 64),
        TeensySlider(PIN_POT_INST_3, 64),
        TeensySlider(PIN_POT_INST_4, 64)}
    , redSlider(PIN_POT_RED, 64)
    , blackSlider(PIN_POT_BLACK, 64)
{
